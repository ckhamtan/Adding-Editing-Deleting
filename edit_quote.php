...
if (!is_administrator()) {
print '<h2>Access Denied!</h2><p class="error">You do not have permission to 
access this page.</p>';
...
<p><label>Quote <textarea name="quote" rows"30">'
...
print '<p>The quotation has been updated.</p>';
	...
	print '<p class="error">COuld not update quotation because:<br>' . mysqli_error($dbc) . '.</p>
	<p>The query being run was: ' . $query . '</p>';
}
} // No Problem!
